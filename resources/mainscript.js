...
document.getElementById("selectSynapseLight").onclick = async function(){
  placeSelect = "SynapseLight";
  console.log(`placeSelect = ${placeSelect}`);
  let draw = true;
  synapseDraw = true;
  while(placeSelect = "SynapseLight"){
  ...
  if(synapseDraw == true && placeSelect == "SynapseLight"){
      ...
      for(let i = 0; i <= neurons.length-1; i++){
        if(x2 > neuronCoordsX[i]-30 && x2 < neuronCoordsX[i]+30 && y2 > neuronCoordsY[i]-30 && y2 < neuronCoordsY[i]+30){
          ...
          neuronsSynapses[neuronSelect].push("l"); //Add connection to array
          break;
        }
      }
...
document.getElementById("selectSynapseMid").onclick = async function(){
  placeSelect = "SynapseMid";
  console.log(`placeSelect = ${placeSelect}`);
  let draw = true;
  synapseDraw = true;
  while(placeSelect = "SynapseMid"){
    ...
    console.log(`Synapsedraw is ${synapseDraw} and placeselect is ${placeSelect}`);
  if(synapseDraw == true && placeSelect == "SynapseMid"){
      //Check whether user clicked on existing neuron
      console.log("Entered synapse func")
      for(let i = 0; i <= neurons.length-1; i++){
        if(x > neuronCoordsX[i]-30 && x < neuronCoordsX[i]+30 && y > neuronCoordsY[i]-30 && y < neuronCoordsY[i]+30){
      ...
      for(let i = 0; i <= neurons.length-1; i++){
        if(x2 > neuronCoordsX[i]-30 && x2 < neuronCoordsX[i]+30 && y2 > neuronCoordsY[i]-30 && y2 < neuronCoordsY[i]+30){
          ...
          Nselect2 = i; 
          neuronsSynapses[neuronSelect].push(Nselect2); //Add connection to array
          neuronsSynapses[neuronSelect].push("m"); //Add connection to array
          break;
        }
      }
...
document.getElementById("selectSynapseHeavy").onclick = async function(){
  placeSelect = "SynapseHeavy";
  console.log(`placeSelect = ${placeSelect}`);
  let draw = true;
  synapseDraw = true;
  while(placeSelect = "SynapseHeavy"){
    ...
    console.log(`Synapsedraw is ${synapseDraw} and placeselect is ${placeSelect}`);
  if(synapseDraw == true && placeSelect == "SynapseHeavy"){
      //Check whether user clicked on existing neuron
      console.log("Entered synapse func")
      for(let i = 0; i <= neurons.length-1; i++){
        if(x > neuronCoordsX[i]-30 && x < neuronCoordsX[i]+30 && y > neuronCoordsY[i]-30 && y < neuronCoordsY[i]+30){
      ...
      for(let i = 0; i <= neurons.length-1; i++){
        if(x2 > neuronCoordsX[i]-30 && x2 < neuronCoordsX[i]+30 && y2 > neuronCoordsY[i]-30 && y2 < neuronCoordsY[i]+30){
          ...
          Nselect2 = i; 
          neuronsSynapses[neuronSelect].push(Nselect2); //Add connection to array
          neuronsSynapses[neuronSelect].push("h"); //Add connection to array
          break;
        }
      }
...
let jsonData = {
                "clk":time_F,
                "nct":nCounter_F,
                "rft":refractoryDelay_F,
                neuronsSynapses,
                "stim":neuronStim
                }
await Neutralino.filesystem.writeFile(jsonPath, JSON.stringify(jsonData, null, 4))
